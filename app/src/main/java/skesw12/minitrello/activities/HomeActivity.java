...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.simple_button).setOnTouchListener(mDelayHideTouchListener);
        ...
        findViewById(R.id.bugged_button).setOnTouchListener(mDelayHideTouchListener);
        findViewById(R.id.bugged_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
